...
from .models import Materiais, Pacote, ItensPacote, SaidaMaterial, Categoria, EntradaMaterial
import datetime
...
class MateriaisAdmin(admin.ModelAdmin):
    ...
    def export_to_excel(self, request, queryset):
        ...
        for material in queryset:
            ...
            ws.cell(row=row_num, column=3).value = material.categoria.nome if material.categoria else ''
...
class EntradaMaterialAdmin(admin.ModelAdmin):
    list_display = ['material', 'quantidade', 'data_entrada', 'remetente']
...
class SaidaMaterialAdmin(admin.ModelAdmin):
    list_display = ['pacote', 'data_saida', 'destino', 'servico']
